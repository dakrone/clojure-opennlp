...
(deftest intersection-span-test
  (is (= (intersection-span (->Span 5 15 :a) (->Span 10 20 :b)) (->Span 10 15 :intersection)))
  (is (= (intersection-span (->Span 10 20 :b) (->Span 5 15 :a)) (->Span 10 15 :intersection)))
  (is (= (intersection-span (->Span 5 20 :b) (->Span 10 15 :a)) (->Span 10 15 :intersection)))
  (is (= (intersection-span (->Span 10 15 :b) (->Span 5 20 :a)) (->Span 10 15 :intersection))))
...
(deftest between-span-test
  (is (= (between-span (->Span 5 10 nil) (->Span 15 20 nil)) (->Span 10 15 :between)))
  (is (= (between-span (->Span 5 10 nil) (->Span 11 20 nil)) (->Span 10 11 :between)))
  (is (= (between-span (->Span 5 10 nil) (->Span 10 20 nil)) (->Span 10 10 :between))))  
